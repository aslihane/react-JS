...
firebase.initializeApp({
  apiKey: "AIzaSyCrSpNQw_Hb7kvtVPQVeAZzhe7-TvWOe3M",
  authDomain: "chat-app-91fff.firebaseapp.com",
  projectId: "chat-app-91fff",
  storageBucket: "chat-app-91fff.appspot.com",
  messagingSenderId: "541799179435",
  appId: "1:541799179435:web:1921e5efde8a00a47283ee"
});
...
function App() {
        ...
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          <h2 className="mb-2 text-3xl flex items-center">
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              className="flex-shrink-0 w-12 h-12 mr-1 text-green-400"
            >
              <path
                fillRule="evenodd"
          ...
          <button
            ...
            className="rounded shadow-button pl-6 pr-8 py-3 bg-white hover:bg-gray-50 text-gray-600 font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-green-400 focus:ring-opacity-75"
          >
            <svg
              viewBox="5 -5 30 30"
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://uretkenakademi.com/">
          <img src="https://uretkenakademi.com/wp-content/uploads/2022/05/uretkenlogo.png" alt="ÜretkenAkademi" width={150} />
        </a>
        <div className="flex items-center">
          {user ? (
            <button
              onClick={signOut}
              className="uppercase text-sm font-medium text-green-400 hover:text-white tracking-wide hover:bg-green-400 bg-transparent rounded py-2 px-4 mr-4 focus:outline-none focus:ring focus:ring-green-400 focus:ring-opacity-75 transition-all"
            >
              Sign out
            </button>
          ) : null}
